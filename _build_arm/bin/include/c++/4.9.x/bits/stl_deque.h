...
public:
    ...
    front() _GLIBCXX_NOEXCEPT {
        ...
        if (empty())
        {
            __throw_logic_error("front() on empty deque");
        }
    ...
    back() _GLIBCXX_NOEXCEPT {
        ...
        if (empty())
        {
            __throw_logic_error("back() on empty deque");
        }
    ...
    pop_front() _GLIBCXX_NOEXCEPT {
        ...
        if (empty())
        {
            __throw_logic_error("pop_front() on empty deque");
        }
    ...
    pop_back() _GLIBCXX_NOEXCEPT {
        ...
        if (empty())
        {
            __throw_logic_error("pop_back() on empty deque");
        }
